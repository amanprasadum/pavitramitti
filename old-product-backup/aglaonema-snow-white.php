      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-7">
          ...
          <div class="pv-feature-pills">
            <span class="pv-pill"><i class="bi bi-wind"></i> Air Refreshing</span>
      ...
      <div class="row g-3 justify-content-center text-center">
        ...
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
            ...
            <div class="pv-feat-title">Air Refreshing</div>
            <div class="pv-feat-sub">Fresh indoor environment</div>
          </div>
        </div>
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-check-list">
              <li><i class="bi bi-check-circle-fill"></i> Enhances indoor décor with bright, attractive foliage</li>
              <li><i class="bi bi-check-circle-fill"></i> Easy to maintain and beginner-friendly</li>
              <li><i class="bi bi-check-circle-fill"></i> Suitable for homes and office environments</li>
              <li><i class="bi bi-check-circle-fill"></i> Adds freshness and greenery to indoor spaces</li>
              <li><i class="bi bi-check-circle-fill"></i> Long-lasting decorative plant</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-usage-list">
              ...
              <li><i class="bi bi-stars"></i> Indoor Decorative Plant</li>
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-check-list">
              ...
              <li><i class="bi bi-check-circle-fill"></i> Delivered as a healthy live Aglaonema Snow White plant</li>
        ...
        <div class="row">
          <div class="col-sm-6">
            <ul class="pv-note-list">
              <li>Leaf color and pattern may vary slightly depending on plant maturity</li>
              <li>Plant size and structure may differ naturally</li>
            </ul>
          </div>
          <div class="col-sm-6">
            <ul class="pv-note-list">
              <li>Avoid direct harsh sunlight and excessive watering</li>
          ...
          <div class="pv-rel-card">
            <a href="aloe-vera.php" class="pv-rel-link">
              ...
              <div class="pv-rel-body">
                <p class="pv-rel-category">Medicinal Plant</p>
                <h3 class="pv-rel-name">Aloe Vera</h3>
