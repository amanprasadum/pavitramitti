    ...
    <div class="container">
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-7">
          ...
          <h1 class="pv-product-title">Allamanda (Alokananda) Live Flower Plant – Bright Yellow Flowering Ornamental Plant for Home, Balcony &amp; Garden</h1>
          ...
          <p class="pv-short-desc">Enhance your garden with the vibrant beauty of our Allamanda (Alokananda) Live Flower Plant, a stunning tropical flowering plant known for its large, bright yellow trumpet-shaped blooms. This attractive ornamental plant is widely admired for its fast growth, long flowering season, and ability to create a cheerful, eye-catching display in outdoor spaces.</p>
          ...
          <div class="pv-feature-pills">
            <span class="pv-pill"><i class="bi bi-flower1"></i> Long Flowering Season</span>
      ...
      <div class="row g-3 justify-content-center text-center">
        ...
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
            ...
            <div class="pv-feat-sub">Blooms all season</div>
          </div>
        </div>
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
        ...
        <div class="col-lg-6">
          <div class="pv-card h-100">
            ...
            <table class="pv-spec-table w-100">
              <tbody>
                <tr><td class="pv-spec-label">Botanical Name</td><td>Allamanda cathartica</td></tr>
                <tr><td class="pv-spec-label">Common Name</td><td>Allamanda / Alokananda / Golden Trumpet</td></tr>
                <tr><td class="pv-spec-label">Plant Type</td><td>Flowering Shrub / Climber</td></tr>
                <tr><td class="pv-spec-label">Flower Color</td><td>Bright Yellow</td></tr>
                ...
                <tr><td class="pv-spec-label">Bloom Size</td><td>Medium to Large trumpet-shaped flowers</td></tr>
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-usage-list">
              ...
              <li><i class="bi bi-border-outer"></i> Boundary &amp; Hedge Planting</li>
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-check-list">
              ...
              <li><i class="bi bi-check-circle-fill"></i> Delivered as a healthy live Allamanda (Alokananda) plant</li>
