    ...
    <div class="container">
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-7">
          ...
          <h1 class="pv-product-title">Rare Pink Double-Petal Hibiscus Plant (Live) – Exotic Layered Flowering Ornamental Plant for Home, Balcony &amp; Garden</h1>
          ...
          <div class="pv-feature-pills">
            <span class="pv-pill"><i class="bi bi-flower1"></i> Rare Double-Petal</span>
      ...
      <div class="row g-3 justify-content-center text-center">
        ...
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
            ...
            <div class="pv-feat-title">Double-Petal</div>
            <div class="pv-feat-sub">Rare layered blooms</div>
          </div>
        </div>
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
        ...
        <div class="col-lg-6">
          <div class="pv-card h-100">
            ...
            <table class="pv-spec-table w-100">
              <tbody>
                <tr><td class="pv-spec-label">Botanical Name</td><td>Hibiscus rosa-sinensis (Double-Petal Hybrid)</td></tr>
                <tr><td class="pv-spec-label">Common Name</td><td>Double-Petal Hibiscus / Layered Hibiscus</td></tr>
                <tr><td class="pv-spec-label">Plant Type</td><td>Perennial Flowering Shrub</td></tr>
                <tr><td class="pv-spec-label">Flower Color</td><td>Rich Pink</td></tr>
                <tr><td class="pv-spec-label">Petal Type</td><td>Double Layer (Multi-Petal)</td></tr>
      ...
      <div class="row g-4">
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-check-list">
              <li><i class="bi bi-check-circle-fill"></i> Secure packaging with plant-safe materials</li>
              <li><i class="bi bi-check-circle-fill"></i> Delivered as a healthy live plant</li>
              <li><i class="bi bi-check-circle-fill"></i> Designed to minimize transit damage</li>
            </ul>
          </div>
        </div>
