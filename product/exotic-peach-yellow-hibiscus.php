  ...
  <section class="pv-product-hero">
    <div class="container">
      <div class="row g-4 align-items-start">
        ...
        <!-- Right: Info -->
        <div class="col-lg-7">
          <span class="pv-category-badge">EXOTIC FLOWERING PLANT</span>
          <h1 class="pv-product-title">Exotic Peach-Yellow Hybrid Hibiscus Plant (Live) – Rare Dual-Tone Flowering Ornamental Plant for Home, Balcony &amp; Garden</h1>
          ...
          <p class="pv-short-desc">Enhance your space with the vibrant beauty of our Exotic Peach-Yellow Hybrid Hibiscus Plant, featuring striking dual-tone blooms that blend soft peach and bright yellow shades. This rare hybrid variety stands out for its unique color contrast and tropical appeal, making it a premium choice for decorative gardening.</p>
          ...
          <div class="pv-feature-pills">
            <span class="pv-pill"><i class="bi bi-flower1"></i> Rare Dual-Tone Blooms</span>
      ...
      <div class="row g-3 justify-content-center text-center">
        ...
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
            ...
            <div class="pv-feat-title">High Flowering</div>
            <div class="pv-feat-sub">Multiple blooms</div>
          </div>
        </div>
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
            ...
            <div class="pv-feat-sub">Loves sunlight</div>
          </div>
        </div>
        <div class="col-6 col-sm-4 col-md-2">
          <div class="pv-feat-item">
          ...
          <div class="pv-card h-100">
            ...
            <table class="pv-spec-table w-100">
              <tbody>
                ...
                <tr><td class="pv-spec-label">Common Name</td><td>Peach-Yellow Hibiscus / Hybrid Hibiscus</td></tr>
                <tr><td class="pv-spec-label">Plant Type</td><td>Perennial Flowering Shrub</td></tr>
                <tr><td class="pv-spec-label">Flower Color</td><td>Peach-Yellow Dual Tone</td></tr>
        ...
        <div class="col-lg-4">
          <div class="pv-card h-100">
            ...
            <ul class="pv-usage-list">
              ...
              <li><i class="bi bi-house-heart"></i> Indoor Decorative Plant (with sunlight)</li>
