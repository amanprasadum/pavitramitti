...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/product-details-enhanced.css">
...
<body>
  ...
  <div class="product-page">
    ...
    <div class="hero-grid">
      ...
      <div class="hero-image-col">
        <img
          src="https://placehold.co/900x420/e9ecef/adb5bd?text=Product+Image"
          alt="Aloe Vera Live Plant"
          class="product-img-main"
        />
        <div class="img-badge-row">
          <span class="img-badge"><i class="bi bi-patch-check-fill"></i> Medicinal Plant</span>
          <span class="img-badge"><i class="bi bi-wind"></i> Air Purifying</span>
          <span class="img-badge"><i class="bi bi-house-heart"></i> Indoor Friendly</span>
        </div>
      </div>
      ...
      <div class="hero-info-col">
        <span class="product-badge">
          <i class="bi bi-flower1"></i> Live Plant
        </span>

        <h1 class="product-title">
          Aloe Vera Live Plant – Medicinal Succulent Plant for Home, Balcony &amp; Indoor Garden
        </h1>

        <hr class="hero-divider"/>

        <!-- Key highlights (from "Why This Aloe Vera Plant is Special") -->
        <div class="hero-highlights">
          <div class="highlight-item">
            <i class="bi bi-check-circle-fill"></i>
            Medicinal &amp; Herbal Plant – Known for natural healing and skincare benefits
          </div>
          <div class="highlight-item">
            <i class="bi bi-check-circle-fill"></i>
          ...
          <div class="highlight-item">
            <i class="bi bi-check-circle-fill"></i>
            Air-Purifying Plant – Helps improve indoor air quality
          </div>
          <div class="highlight-item">
            <i class="bi bi-check-circle-fill"></i>
            Climate Friendly – Thrives well in Indian weather conditions
          </div>
          <div class="highlight-item">
            <i class="bi bi-check-circle-fill"></i>
            Multi-Purpose Plant – Useful for home remedies, beauty, and décor
          </div>
        </div>
        ...
        <div class="cta-group">
          ...
          >
            ...
            <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16 3C9.373 3 4 8.373 4 15c0 2.385.668 4.61 1.822 6.503L4 29l7.697-1.797A12.93 12.93 0 0016 28c6.627 0 12-5.373 12-12S22.627 3 16 3z" fill="#fff" fill-opacity=".15"/>
              <path d="M16 4.5C10.201 4.5 5.5 9.201 5.5 15c0 2.21.71 4.257 1.912 5.928L6 26l5.23-1.37A11.43 11.43 0 0016 25.5c5.799 0 10.5-4.701 10.5-10.5S21.799 4.5 16 4.5z" fill="#fff"/>
              <path d="M21.5 18.3c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.47-.89-.79-1.49-1.76-1.66-2.06-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.6-.92-2.19-.24-.57-.49-.49-.67-.5h-.57c-.2 0-.52.07-.79.37-.27.3-1.03 1.01-1.03 2.46s1.06 2.85 1.2 3.05c.15.2 2.07 3.18 5.03 4.46.7.3 1.25.48 1.67.62.7.22 1.34.19 1.84.12.56-.08 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35z" fill="#25d366"/>
            </svg>
            Chat on WhatsApp
          </a>
    ...
    <div class="section-card">
      ...
      <div class="care-grid">
        ...
        <div class="care-card">
          <div class="care-icon"><i class="bi bi-brightness-high"></i></div>
          <div class="care-label">Sunlight Requirement</div>
          <ul>
        ...
        <div class="care-card">
          <div class="care-icon"><i class="bi bi-layers"></i></div>
          <div class="care-label">Soil Type</div>
          <ul>
        ...
        <div class="care-card">
          <div class="care-icon"><i class="bi bi-flower1"></i></div>
          <div class="care-label">Fertilization</div>
          <ul>
        ...
        <div class="care-card">
          <div class="care-icon"><i class="bi bi-scissors"></i></div>
  ...
  <div class="sticky-cta">
    <a
      ...
      style="flex:1"
    >
      <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="width:20px;height:20px;flex-shrink:0">
        <path d="M21.5 18.3c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.47-.89-.79-1.49-1.76-1.66-2.06-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.6-.92-2.19-.24-.57-.49-.49-.67-.5h-.57c-.2 0-.52.07-.79.37-.27.3-1.03 1.01-1.03 2.46s1.06 2.85 1.2 3.05c.15.2 2.07 3.18 5.03 4.46.7.3 1.25.48 1.67.62.7.22 1.34.19 1.84.12.56-.08 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35z" fill="#fff"/>
        <path d="M16 4.5C10.201 4.5 5.5 9.201 5.5 15c0 2.21.71 4.257 1.912 5.928L6 26l5.23-1.37A11.43 11.43 0 0016 25.5c5.799 0 10.5-4.701 10.5-10.5S21.799 4.5 16 4.5z" fill="#25d366"/>
      </svg>
      Chat on WhatsApp
    </a>
    <a href="tel:+91XXXXXXXXXX" class="btn-call" style="flex:1">
